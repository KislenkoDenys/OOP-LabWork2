...
namespace OOP_LabWork2
{
    ...
    {
        private readonly List<IXmlAnalysisStrategy> _strategies;
        private IXmlAnalysisStrategy _currentStrategy;
        ...
        {
            InitializeComponent();
            _strategies = new List<IXmlAnalysisStrategy>
            {
                new SaxAnalysisStrategy(),
        ...
        private async void ExportHtmlButton_Clicked(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string htmlContent = transformer.TransformXmlToHtml(xmlData, _xslContent);
        ...
        private void UpdateWebView(string xmlData)
        {
            ...
            var transformer = new XslTransformer();
            var html = transformer.TransformXmlToHtml(xmlData, _xslContent);
